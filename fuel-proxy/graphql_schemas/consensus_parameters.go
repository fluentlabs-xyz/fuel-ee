...
func ConsensusParameters(
	...
	objectConfig := graphql.ObjectConfig{Name: "ConsensusParameters", Fields: graphql.Fields{
		"version": &graphql.Field{
			Type: consensusParametersVersionType.SchemaFields.Entity,
		...
		"baseAssetId": &graphql.Field{
			...
			Resolve: func(p graphql.ResolveParams) (interface{}, error) {
				return graphql_types.NewBytes32TryFromStringOrPanic("0xf8f8b6283d7fa5b672b530cbb84fcccb4ff8dc40f8176ef4544ddb1f1952ad07"), nil
			},
		},
	}}
